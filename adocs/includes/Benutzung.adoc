...
[IMPORTANT]
====
Vor dem Abschluss eines Abrechnungszeitraumes ist sicherzustellen, dass die BasisDaten auf dem aktuellen Stand sind. Zur Sicherheit sollte kurz vorher die Mitgliederwartin aufgefordert werden, noch einmal frische Daten aus dem Mitgliederverwaltungsprogramm zu exportieren und hochzuladen!
====
