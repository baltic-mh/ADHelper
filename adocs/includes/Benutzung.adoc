...
Guthaben III::
    Die Summe der Werte in der Spalte #Guthaben II# stellt das "Familienguthaben" dar. Die Summe der Werte in der Spalte #Zu zahlen# stellt die #Familienschuld# dar. In der Spalte #Guthaben III# wird das Familienguthaben gegen die Familienschuld aufgerechnet. Dabei werden die Guthaben der Familienmitglieder gleichmäßig reduziert.
