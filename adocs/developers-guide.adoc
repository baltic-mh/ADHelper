...
[TIP]
====
Einen einzelnen Branch klont man mit folgendem Befehl:
...
| FILENAME_COLUMNNAMESMAPPING   | ColumnNamesMapping.properties | Mapping der Spaltennamen der Basisdatei
...
| HOURLY_RATE                   | 9.0           | Stundensatz in Euro für Ersatzzahlungen
|=======================
...
=== Spaltenüberschriften Basisdatei

Die Daten, die vom Vereinsverwaltungsprogramm exportiert werden, haben sich mit Übergang auf Version SPG 4 leider geändert.
Daher musste ein Mapping eingeführt werden, das die neuen Spaltennamen auf die alten abbildet.
Das wird in der Datei `ColumnNamesMapping.properties` konfiguriert.

Ort der Datei: `\src\main\resources\ColumnNamesMapping.properties`
...
[options="header"]
|=======================
| Spaltenüberschrift | wird abgebildet auf 
| MitgliedID         |  Mitglieds_Nr
| Eintritt_Datum     |  Eintritt
| Austritt_Datum     |  Austritt
| Zusatzfeld_02      |  AD-Frei.Grund
| Zusatzfeld_03      |  AD-Frei.von
| Zusatzfeld_04      |  AD-Frei.bis
|=======================
