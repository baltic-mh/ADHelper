...
public class HalfyearTest
{
    ...
    {
        final boolean aWithinMyBounds1 = HY.isWithinMyBounds( sm_RefDate1 );
        assertTrue("WithinMyBounds1", aWithinMyBounds1 );
        final boolean aWithinMyBounds2 = HY.isWithinMyBounds( sm_RefDate2 );
        assertTrue("WithinMyBounds2", aWithinMyBounds2 );
        final boolean aWithinMyBounds3 = HY.isWithinMyBounds( sm_RefDate1_PreviousDay );
        assertFalse("WithinMyBounds3", aWithinMyBounds3 );
        final boolean aWithinMyBounds4 = HY.isWithinMyBounds( sm_RefDate2_NextDay );
