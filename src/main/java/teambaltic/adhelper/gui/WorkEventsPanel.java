...
public class WorkEventsPanel extends JPanel
{
    ...
    public WorkEventsPanel()
    {
        ...
        m_FilterController = new WorkEventsFilterController( m_sorter, m_btn_ToggleTeilnehmerFilter, m_tf_Filter );
    ...
    public void populate(final TBLModel_WorkEvents fModel)
    {
        ...
        m_table.getColumn("Stunden").setCellEditor(new WorkedHoursSpinnerEditor());
