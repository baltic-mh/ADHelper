...
//            final File aFileNew = new File("misc\\TestResources\\IntegrityChecker\\BasisDaten_ExportVonUschi.csv");
            final File aFileRef = new File("misc\\TestResources\\IntegrityChecker\\BaisDaten-SPG4-1-complete.csv");
            final File aFileNew = new File("misc\\TestResources\\IntegrityChecker\\BaisDaten-SPG4-1-complete-mitModifikationen.csv");
